...
# Here we remove the non-gradable inspection types, special program and administrative
# violations that do not contribute towards overall score and grade.
# Dataframe is narrowed down to the four gradable inspections only.
...
# Now, try to organize the scores and grades for the facilities based on inspection type.
...
# before operations can be resume.
...
# The inspection type, Pre-permit (Operational) / Reopening Inspection that are assigned a score and grade z
# should be removed.
# Why? Because for this type of inspection, the score and grade do not contribute to the regular cycle inspection.
# Note this applies primarily to new facilities that failed to comply to with Health codes prior to permit approval,
